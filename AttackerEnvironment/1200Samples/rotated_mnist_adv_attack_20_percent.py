...
torch.save(model_domain_incre_si.state_dict(), 'model_domain_incre_si_adv_attack_20_percent.pth')
...
torch.save(model_domain_incre_ewc.state_dict(), 'model_domain_incre_ewc_adv_attack_20_percent.pth')
...
torch.save(model_domain_incre_online_ewc.state_dict(), 'model_domain_incre_online_ewc_adv_attack_20_percent.pth')

"""# Saving the Performance Metrics"""

performance_rotated_mnist.to_csv("continual_learning_performance_RotatedMNIST_20_percent_1200_samples.csv")
