...
def start_poisoning_trial(model, target_batches, poison_batches, epsilon, iterations, decay_factor, num_classes, step_size):
    ...
    for images, labels in target_batches:
        ...
        counter = counter + 1
    #print("gradients",target_gradients)
    ...
    for t in range(iterations):
        ...
        for images, labels in poison_batches:
            #print("counter_poison = ",counter_poison)
...
torch.save(model_domain_incre_si.state_dict(), 'model_domain_incre_si_adv_attack_15_percent.pth')
...
torch.save(model_domain_incre_ewc.state_dict(), 'model_domain_incre_ewc_adv_attack_15_percent.pth')
...
torch.save(model_domain_incre_online_ewc.state_dict(), 'model_domain_incre_online_ewc_adv_attack_15_percent.pth')

"""# Saving the Performance Metrics"""

performance_rotated_mnist.to_csv("continual_learning_performance_RotatedMNIST_15_percent_1200_samples.csv")
