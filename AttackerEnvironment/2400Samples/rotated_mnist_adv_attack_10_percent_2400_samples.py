# -*- coding: utf-8 -*-
"""rotated_mnist_adv_attack_10_percent.ipynb
"""
...
train_indices = random.sample(range(0,60000),2400)
test_indices = random.sample(range(0,10000),400)
...
torch.save(model_domain_incre_si.state_dict(), 'model_domain_incre_si_adv_attack_10_percent_2400_samples.pth')
...
torch.save(model_domain_incre_ewc.state_dict(), 'model_domain_incre_ewc_adv_attack_10_percent_2400_samples.pth')
...
torch.save(model_domain_incre_online_ewc.state_dict(), 'model_domain_incre_online_ewc_adv_attack_10_percent_2400_samples.pth')

"""# Saving the Performance Metrics"""

performance_rotated_mnist.to_csv("continual_learning_performance_RotatedMNIST_final_10_percent_2400_samples.csv", sep = ";")
