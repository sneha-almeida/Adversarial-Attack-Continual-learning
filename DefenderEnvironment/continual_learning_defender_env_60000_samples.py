...
train_indices = random.sample(range(0,60000),59999)
test_indices = random.sample(range(0,10000),9999)
...
torch.save(model_domain_incre_si.state_dict(), 'model_domain_incre_si_60000_samples.pth')
...
torch.save(model_domain_incre_ewc.state_dict(), 'model_domain_incre_ewc_60000_samples.pth')
...
torch.save(model_domain_incre_online_ewc.state_dict(), 'model_domain_incre_online_ewc_60000_samples.pth')
...
performance_rotated_mnist.to_csv("continual_learning_performance_RotatedMNIST_60000_samples.csv")
...
torch.save(model_task_incre_si.state_dict(), 'model_task_incre_si_60000_samples.pth')
...
torch.save(model.state_dict(), 'model_task_incre_ewc_60000_samples.pth')
...
torch.save(model_task_incre_online_ewc.state_dict(), 'model_task_incre_online_ewc_60000_samples.pth')
...
performance_mnist_fellowship.to_csv("continual_learning_performance_MNIST_fellowship_60000_samples.csv")
