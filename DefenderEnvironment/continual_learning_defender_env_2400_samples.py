...
performance_rotated_mnist.to_csv("continual_learning_performance_RotatedMNIST_final_2400_samples.csv")
...
performance_mnist_fellowship.to_csv("continual_learning_performance_MNIST_fellowship_2400_samples.csv")
